...
!function (a) {
    ...
    var c = function (b) {
        ...
        b.on("snap.util.grad.parse", function (a) {
            ...
            if (b.stop(), "text" == this.type) {
                ...
                if (c)if (d = this.textPath, g = this.node, d)d.attr({"xlink:href": "#" + c}); else {
    ...
    return d.plugin(function (a, b) {
        ...
        function x(a, b, c, d, f) {
            if (null == f && null == d && (d = c), null != f)var g = Math.PI / 180, h = a + c * Math.cos(-d * g), i = a + c * Math.cos(-f * g), j = b + c * Math.sin(-d * g), k = b + c * Math.sin(-f * g), l = [
                ["M", h, j],
        ...
        j.stroke = j.fill = "colour", b.prototype.equal = function (b, c) {
            ...
            if ("points" == b)return m = l(o).split(","), n = l(c).split(","), {from: m, to: n, f: function (a) {
                return a
            }};
