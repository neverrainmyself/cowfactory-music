...
function welcome(type) {
    $.ajax({
        ...
        success: function (result) {
            $('.nav-tabs-list .active').removeClass('active');
            $('.nav-tabs-list .defaultlist').addClass('active');
            $('.default-music-list').remove();
            $('.page-'+direction+' .page-inner').append(result);
            $('.playlist').show();
        }
    });
}
...
function top100(type){
    $.ajax({
        ...
        success: function (result) {
            $('.nav-tabs-list .active').removeClass('active');
            $('.nav-tabs-list .top100list').addClass('active');
            $('.default-music-list').remove();
            $('.page-'+direction+' .page-inner').append(result);
            $('.playlist').show();
        }
